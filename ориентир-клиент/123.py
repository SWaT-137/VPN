...
from PySide6.QtWidgets import (QApplication, QPushButton, QDialog,
                               QLabel, QVBoxLayout, QLineEdit, QMessageBox, QTabWidget, QWidget)
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        # Кнопка "Статистика"
        self.button3 = QPushButton("Статистика", self)
        self.button3.setGeometry(60, 230, 100, 30)
        self.button3.clicked.connect(self.open_new_window_stat)
        self.ping = 30
        self.speed = 30
        self.speed1 = 30
        pakets = 50
